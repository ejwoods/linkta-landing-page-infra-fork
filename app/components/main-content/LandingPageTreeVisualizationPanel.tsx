  ...
  return (
    <div className='min-w-[360px] -mt-24 sm:-mt-8 '>
      <div className="hidden sm:block mt-4">
        ...
        className="w-full -ml-24" scene="https://prod.spline.design/3EDxf9YSTlnBoD1H/scene.splinecode" />
      </div>
      <div className='sm:hidden'>
        <Spline className='' scene="https://prod.spline.design/n30RNsX1c9-QGXnZ/scene.splinecode" />
      </div>
      <h2 className="block sm:hidden font-serif font-bold text-2xl -mt-36 mb-24 pl-2 text-light-text">Discover the IA Structure of Knowledge with AI</h2>
    </div>
  );
}
