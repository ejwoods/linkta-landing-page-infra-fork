...
export default function LandingPageTreeVisualizationPanel() {
  ...
  return (
    <div className='min-w-[360px] -mt-24 sm:-mt-8 '>
      ...
      <h2 className="block sm:hidden font-serif font-bold text-3xl -mt-36 mb-24 pl-2 text-light-text">Discover the <span className='font-cursive text-4xl -mt-8 inline-block align-baseline mx-2 text-light-accent'> IA </span> of Knowledge with the help of <span className='font-cursive text-4xl inline-block align-baseline ml-2 text-light-border'> AI </span></h2>
      <h4 className="block sm:hidden font-sans font-semibold text-base ml-1 leading-tight -mt-20 mb-24 pl-2 text-light-text"> Our tool allows you to see the big picture and reveals the connections between ideas, enabling you to focus on what matters most.</h4>
    </div>
  );
}
