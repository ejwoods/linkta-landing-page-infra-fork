...
export default function NotFound() {
  ...
  return (
    <div>
      ...
      <p className="mb-64 text-light-text">Please click <a href="/" className="font-bold hover:text-red-500">here</a> to return home or contact us at <a href="mailto:info@linkta.org" className="underline">info@linkta.org</a></p>
    </div>
  )
};
